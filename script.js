...
const translations = {
    ...
    ro: {
        // Navigation
        'nav-vocab': 'Vocabular',
        'nav-grammar': 'Gramatică',
        'nav-pronunciation': 'Pronunție',
        'nav-exercises': 'Exerciții',
        'nav-tests': 'Teste',
        
        // Hero
        'hero-title': 'Învață Germană - de la A1 la C2',
        'hero-subtitle': 'Platforma ta completă pentru stăpânirea limbii germane',
        'hero-desc': 'De la începători la vorbitori nativi - totul într-un singur loc',
        
        // Welcome
        'welcome-title': 'Bine ai venit la platforma de învățare a limbii germane!',
        'welcome-text': 'Aici vei găsi tot ce ai nevoie pentru a învăța germana perfect. De la nivelul A1 la C2, cu teste interactive și exerciții distractive.',
        
        // Vocabulary
        'vocab-title': 'Vocabular German',
        'vocab-intro': 'Învață vocabularul german esențial cu exemple',
        'vocab-search': 'Caută în vocabular...',
        'vocab-all': 'Toate',
        'vocab-favorites': 'Favorite',
        
        // Lesson A1.1
        'lesson-a1-1': 'Salutări Importante',
        'lesson-a1-1-goal': 'Învață salutările de bază în germană',
        'lesson-german': 'Germană',
        'lesson-article': 'Articol/Formă',
        'lesson-english': 'Engleză',
        'lesson-type': 'Tip',
        
        // Grammar
        'grammar-title': 'Gramatica Germană',
        'grammar-articles': 'Articole: der, die, das',
        'grammar-masc': 'Masculin',
        'grammar-fem': 'Feminin',
        'grammar-neut': 'Neutru',
        'grammar-plural': 'Plural',
        
        // Pronunciation
        'pronunciation-title': 'Ghid de Pronunție',
        'pronunciation-sounds': 'Sunete germane importante',
        
        // Flashcards
        'flashcards-title': 'Carduri de Memorare',
        'flashcards-desc': 'Exersează vocabularul interactiv',
        'flashcards-known': 'Știu asta',
        'flashcards-unknown': 'Nu știu',
        'flashcards-next': 'Următorul',
        'flashcards-prev': 'Anterior',
        'flashcards-shuffle': 'Amestecă',
        
        // Voice Recording
        'voice-title': 'Înregistrare Vocală',
        'voice-desc': 'Exersează pronunția',
        'voice-record': 'Înregistrează',
        'voice-stop': 'Oprește',
        'voice-play': 'Redă',
        'voice-delete': 'Șterge',
        'voice-next': 'Cuvântul Următor',
        
        // Custom Audio
        'custom-audio-title': 'Audio Personalizat',
        'custom-audio-desc': 'Încarcă fișiere audio de la Matthias',
        'custom-audio-upload': 'Alege Fișier',
        'custom-audio-drop': 'sau trage fișierul aici',
        
        // Exercises
        'exercises-title': 'Exerciții Interactive',
        'exercises-desc': 'Exersează și îmbunătățește-ți abilitățile',
        
        // Statistics
        'stats-title': 'Statisticile Tale',
        'stats-desc': 'Urmărește progresul tău',
        'stats-streak': 'Zile consecutive',
        'stats-exercises': 'Exerciții completate',
        'stats-vocab': 'Cuvinte învățate',
        'stats-minutes': 'Minute de învățare',
        ...
        'c1-desc': 'Antrenament țintit pentru toate părțile examenului: Înțelegere scrisă, Înțelegere orală, Expresie scrisă și Expresie orală',
        'c1-feat1': 'Strategii de examen',
        'c1-feat2': 'Teste model',
        'c1-feat3': 'Management al timpului',
        'c1-feat4': 'Criterii de evaluare',
        'c1-open': 'Start examen C1'
    }
};
